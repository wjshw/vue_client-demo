...
<div class="tab-pane active meal_page">
  ...
  <el-dialog width="300px" :visible.sync="payPopups" customClass="wechatPay" center @close="qrcodeClose">
  <div slot="title"><span class="icon iconfont" :class="payWays.iconClass"></span> {{payWays.title}}</div>
  <div class="ewm">
    <img :src="payWays.imgSrc">
  </div>
...
<script>
import weiPayPic from '@/assets/img/weixinqr.png'
import aliPayPic from '@/assets/img/aliqr.png'
  export default {
    name: 'Beverage',
    data() {
      return {
